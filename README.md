...
# Summary
This is a new working (in progress) version of an old app made circa 2005 for IE 5+. The original version can be found [here](https://github.com/heribertolugo/EmissionsLambda);\
